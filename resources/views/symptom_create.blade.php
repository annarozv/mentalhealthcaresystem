            ...
            <div class="col-sm-8 mx-auto">
                ...
                <form method="POST" action="{{ route('symptom.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('symptom_name') is-invalid @enderror" id="symptom_name" name="symptom_name" type="text">
                        @error('symptom_name')
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('latvian_symptom_name') is-invalid @enderror" id="latvian_symptom_name" name="latvian_symptom_name" type="text">
