            ...
            <div class="col-sm-8 mx-auto">
                ...
                <form method="POST" action="{{ route('illness.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('illness_name') is-invalid @enderror" id="illness_name" name="illness_name" type="text" value="{{ old('illness_name') }}">
                        @error('illness_name')
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('latvian_illness_name') is-invalid @enderror" id="latvian_illness_name" name="latvian_illness_name" type="text" value="{{ old('latvian_illness_name') }}">
